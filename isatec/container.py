...
class EventReceptorBase(iSATecObject):
    ...
    def OnLaunch(self):
        """Called when the iSATec is launched. This method is intended to be overridden.
        """
        pass

    def OnExitEvent(self):
        """Called when the iSATec is exited. This method is intended to be overridden.
        """
        pass
...
class PanelBase(CommunicableObjectBase, SettingStorableObjectBase, EventReceptorBase, Panel):
    """Base class for panel UI used in iSATec
    """

    def __init__(self, *args, **kw):
        """Default constructor
        """
        super(iSATecObject, self).__init__(*args, **kw)
