...
class iSATecEventBinder(PyEventBinder, iSATecObject):
    """Binder of events related to iSATec.
    """
    pass


class iSATecEvent(PyCommandEvent):
    """Events managed by iSATec.
    """
    pass


wxEVT_PROJECT_NEW = NewEventType()
EVT_PROJECT_NEW = iSATecEventBinder(wxEVT_PROJECT_NEW)

wxEVT_PROJECT_OPEN = NewEventType()
EVT_PROJECT_OPEN = iSATecEventBinder(wxEVT_PROJECT_OPEN)

wxEVT_PROJECT_SAVE = NewEventType()
EVT_PROJECT_SAVE = iSATecEventBinder(wxEVT_PROJECT_SAVE)

wxEVT_PROJECT_MEMO_CHANGE = NewEventType()
EVT_PROJECT_MEMO_CHANGE = iSATecEventBinder(wxEVT_PROJECT_MEMO_CHANGE)

wxEVT_PROJECT_EXIT = NewEventType()
EVT_PROJECT_EXIT = iSATecEventBinder(wxEVT_PROJECT_EXIT)

wxEVT_DATA_CONTENTS_CHANGE = NewEventType()
EVT_DATA_CHANGE = iSATecEventBinder(wxEVT_DATA_CONTENTS_CHANGE)

wxEVT_DATA_SELECTION_CHANGE = NewEventType()
EVT_DATA_SELECTION_CHANGE = iSATecEventBinder(wxEVT_DATA_SELECTION_CHANGE)

wxEVT_ENCODE_FUNCTION_SELECT = NewEventType()
EVT_ENCODE_FUNCTION_SELECT = iSATecEventBinder(wxEVT_ENCODE_FUNCTION_SELECT)

wxEVT_DECODE_FUNCTION_SELECT = NewEventType()
EVT_DECODE_FUNCTION_SELECT = iSATecEventBinder(wxEVT_DECODE_FUNCTION_SELECT)

wxEVT_MAPPING_FUNCTION_SELECT = NewEventType()
EVT_MAPPING_FUNCTION_SELECT = iSATecEventBinder(wxEVT_MAPPING_FUNCTION_SELECT)

wxEVT_SPECTRUM_FUNCTION_LIST_SELECT = NewEventType()
EVT_SPECTRUM_FUNCTION_LIST_SELECT = iSATecEventBinder(wxEVT_SPECTRUM_FUNCTION_LIST_SELECT)

wxEVT_ENCODE_FUNCTION_REGISTER = NewEventType()
EVT_ENCODE_FUNCTION_REGISTER = iSATecEventBinder(wxEVT_ENCODE_FUNCTION_REGISTER)

wxEVT_ENCODE_FUNCTION_DEREGISTER = NewEventType()
EVT_ENCODE_FUNCTION_DEREGISTER = iSATecEventBinder(wxEVT_ENCODE_FUNCTION_DEREGISTER)

wxEVT_DECODE_FUNCTION_REGISTER = NewEventType()
EVT_DECODE_FUNCTION_REGISTER = iSATecEventBinder(wxEVT_DECODE_FUNCTION_REGISTER)

wxEVT_DECODE_FUNCTION_DEREGISTER = NewEventType()
EVT_DECODE_FUNCTION_DEREGISTER = iSATecEventBinder(wxEVT_DECODE_FUNCTION_DEREGISTER)

wxEVT_SPECTRUM_FUNCTION_REGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_REGISTER = iSATecEventBinder(wxEVT_SPECTRUM_FUNCTION_REGISTER)

wxEVT_SPECTRUM_FUNCTION_DEREGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_DEREGISTER = iSATecEventBinder(wxEVT_SPECTRUM_FUNCTION_DEREGISTER)

wxEVT_PEAK_FUNCTION_REGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_REGISTER = iSATecEventBinder(wxEVT_PEAK_FUNCTION_REGISTER)

wxEVT_PEAK_FUNCTION_DEREGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_DEREGISTER = iSATecEventBinder(wxEVT_PEAK_FUNCTION_DEREGISTER)

wxEVT_MAPPING_FUNCTION_REGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_REGISTER = iSATecEventBinder(wxEVT_MAPPING_FUNCTION_REGISTER)

wxEVT_MAPPING_FUNCTION_DEREGISTER = NewEventType()
EVT_SPECTRUM_FUNCTION_DEREGISTER = iSATecEventBinder(wxEVT_MAPPING_FUNCTION_DEREGISTER)

wxEVT_ENCODE = NewEventType()
EVT_ENCODED = iSATecEventBinder(wxEVT_ENCODE)
# EVT_ENCODED_FUNCTION = CustomEventBinder(wxEVT_ENCODE)

wxEVT_DECODE = NewEventType()
EVT_DECODE = iSATecEventBinder(wxEVT_DECODE)
# EVT_DECODE_FUNCTION = CustomEventBinder(wxEVT_DECODE)

wxEVT_TABLE_SIZE_CHANGE = NewEventType()
EVT_TABLE_SIZE = iSATecEventBinder(wxEVT_TABLE_SIZE_CHANGE)

wxEVT_DIRECTION_CHANGE = NewEventType()
EVT_DIRECTION = iSATecEventBinder(wxEVT_DIRECTION_CHANGE)

wxEVT_RECIPE_SELECT = NewEventType()
EVT_RECIPE_SELECT = iSATecEventBinder(wxEVT_RECIPE_SELECT)

wxEVT_PRESET_REGISTER = NewEventType()
EVT_PRESET_REGISTER = iSATecEventBinder(wxEVT_PRESET_REGISTER)

wxEVT_PRESET_DEREGISTER = NewEventType()
EVT_PRESET_DEREGISTER = iSATecEventBinder(wxEVT_PRESET_DEREGISTER)

wxEVT_PRESET_SELECT = NewEventType()
EVT_PRESET_SELECT = iSATecEventBinder(wxEVT_PRESET_SELECT)

wxEVT_PEAK_TYPE_REGISTER = NewEventType()
EVT_PEAK_TYPE_REGISTER = iSATecEventBinder(wxEVT_PEAK_TYPE_REGISTER)

wxEVT_PEAK_TYPE_CHANGE = NewEventType()
EVT_PEAK_TYPE_CHANGE = iSATecEventBinder(wxEVT_PEAK_TYPE_CHANGE)

wxEVT_PANEL_SELECTION_CHANGE = NewEventType()
EVT_PANEL_SELECTION_CHANGE = iSATecEventBinder(wxEVT_PANEL_SELECTION_CHANGE)

wxEVT_PANEL_VIEW = NewEventType()
EVT_PANEL_VIEW = iSATecEventBinder(wxEVT_PANEL_VIEW)

wxEVT_PANEL_REGISTER = NewEventType()
EVT_PANEL_REGISTER = iSATecEventBinder(wxEVT_PANEL_REGISTER)

wxEVT_LAYOUT_CHANGE = NewEventType()
EVT_LAYOUT_CHANGE = iSATecEventBinder(wxEVT_LAYOUT_CHANGE)

wxEVT_LAYOUT_REGISTER = NewEventType()
EVT_LAYOUT_REGISTER = iSATecEventBinder(wxEVT_LAYOUT_REGISTER)

wxEVT_PREFERENCE = NewEventType()
EVT_PREFERENCE = iSATecEventBinder(wxEVT_PREFERENCE)

wxEVT_COLOR_REGISTER = NewEventType()
EVT_COLOR_REGISTER = iSATecEventBinder(wxEVT_COLOR_REGISTER)

wxEVT_COLOR_SELECT = NewEventType()
EVT_COLOR_SELECT = iSATecEventBinder(wxEVT_COLOR_SELECT)

wxEVT_COLORMAP_CHANGE = NewEventType()
EVT_COLOR_MAP_CHANGE = iSATecEventBinder(wxEVT_COLORMAP_CHANGE)

wxEVT_LAUNCH = NewEventType()
EVT_LAUNCH = iSATecEventBinder(wxEVT_LAUNCH)

wxEVT_EXIT = NewEventType()
EVT_EXIT = iSATecEventBinder(wxEVT_EXIT)


class ProjectEvent(iSATecEvent):
...
class FunctionEvent(iSATecEvent):
...
class MappingEvent(iSATecEvent):
...
class PeakTypeEvent(iSATecEvent):
...
class PreferenceEvent(iSATecEvent):
...
class LaunchEvent(iSATecEvent):
    """iSATec launched event
    """
